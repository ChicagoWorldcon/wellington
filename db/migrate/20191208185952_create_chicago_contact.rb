...
# Based initially off https://registration.chicagoworldcon.org/new/BidSupporter
class CreateChicagoContact < ActiveRecord::Migration[6.0]
  def change
    # Initial model based on Conzealand contact form, can be modified
    create_table :chicago_contacts, force: :cascade do |t|
