...
hugo = Election.create!(name: "2022 Hugo", i18n_key: "hugo")
hugo.categories.create!(
  name: "Best Novel",
  description: %{
    A science fiction or fantasy story of 40,000 words or more, published for the first time in 2021.
  }.strip_heredoc,
  field_1: "Title",
  field_2: "Author",
  field_3: "Publisher",
...
hugo.categories.create!(
  name: "Best Novella",
  description: %{
    A science fiction or fantasy story between 17,500 and 40,000 words, which appeared for the first time in 2021.
  }.strip_heredoc,
  field_1: "Title",
  field_2: "Author",
...
hugo.categories.create!(
  name: "Best Novelette",
  description: %{
    A science fiction or fantasy story between 7,500 and 17,500 words, which appeared for the first time in 2021.
  }.strip_heredoc,
  field_1: "Title",
  field_2: "Author",
  field_3: "Where Published",
...
hugo.categories.create!(
  ...
  description: %{
    A science fiction or fantasy story of fewer than 7,500 words, which appeared for the first time in 2021.
  }.strip_heredoc,
  field_1: "Title",
  field_2: "Author",
  field_3: "Where Published",
...
hugo.categories.create!(
  ...
  description: %{
    ...
    by the close of the calendar year 2021, at least one of which was published in 2021, and which has not
    ...
    **Note regarding 2022 Best Series eligibility**
    ...
    * Wayfarers, by Becky Chambers
    ...
    The following finalists for the Hugo Award for Best Series in 2017 are **not** eligible in 2022 **unless** they have
    ...
    * The Temeraire series, by Naomi Novik
    ...
    The following finalists for the Hugo Award for Best Series in 2020 are **not** eligible in 2022 **unless** they have
    published at least two (2) additional installments consisting in total of at least 240,000 words between 1 January
    ...
    * The Stormlight Archive, Brandon Sanderson
    ...
    The following finalists for the Hugo Award for Best Series in 2021 are **not** eligible in 2022 **unless** they have
    published at least two (2) additional installments consisting in total of at least 240,000 words between 1 January
    2020 and 31 December 2021:
  ...
  field_1: "Series Name",
  field_2: "Author",
  field_3: "2021 Example from Series",
)
hugo.categories.create!(
  name: "Best Related Work",
  description: %{
    Any work related to the field of science fiction, fantasy, or fandom, appearing for the first time in 2021, or
    which has been substantially modified during 2021, and which is either non-fiction or, if fictional, is
...
hugo.categories.create!(
  ...
  description: %{
    Any science fiction or fantasy story told in graphic form, appearing for the first time in 2021.
  }.strip_heredoc,
  field_1: "Title",
  field_2: "Author",
  field_3: "Publisher",
...
hugo.categories.create!(
  ...
  description: %{
    ...
    time in its present dramatic form during 2021.
  }.strip_heredoc,
  field_1: "Title",
...
hugo.categories.create!(
  ...
  description: %{
    ...
    media) primarily devoted to science fiction and/or fantasy, at least one of which was published in 2021.
  }.strip_heredoc,
  field_1: "Editor",
  field_2: nil,
  field_3: nil,
...
hugo.categories.create!(
  ...
  description: %{
    ...
    published in 2021, which do not qualify under Best Editor, Short Form.
  }.strip_heredoc,
  field_1: "Editor",
  field_2: nil,
  field_3: nil,
...
hugo.categories.create!(
  ...
  description: %{
    ...
    fantasy during 2021. A professional publication is one that meets at least one (1) of the following criteria:
...
hugo.categories.create!(
  ...
  description: %{
    ...
    of 2021 had published at least four (4) issues (or the equivalent in other media), and at least one (1) of
    which appeared in 2021, which does not qualify as a fancast, and which in 2021 has met at least one (1) of the
    following criteria:
...
hugo.categories.create!(
  ...
  description: %{
    ...
    by the close of 2021, had published at least four (4) issues (or the equivalent in other media), at least one (1) of
    which appeared in 2021, and which does not qualify as a semiprozine or a fancast, and which in 2021 met neither of
...
hugo.categories.create!(
  ...
  description: %{
    ...
    related subjects that by the close of 2021 has released four (4) or more episodes, at least one (1) of which
    appeared in 2021, and that does not qualify as a dramatic presentation.
  }.strip_heredoc,
...
hugo.categories.create!(
  ...
  description: %{
    ...
    other public non-professional display (including at a convention or conventions) in 2021.
  }.strip_heredoc,
...
hugo.categories.create!(
  ...
  description: %{
    A new writer is one whose first work of science fiction or fantasy appeared in 2020 or 2021 in a professional
...
retro_hugo = Election.create!(name: "1947 Retro Hugo", i18n_key: "retro_hugo")
