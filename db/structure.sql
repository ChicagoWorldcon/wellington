...
--
-- Name: index_site_selection_tokens_on_voter_id_and_election; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX index_site_selection_tokens_on_voter_id_and_election ON public.site_selection_tokens USING btree (voter_id, election);
