...
RSpec.describe Category, type: :model do
  [
    ...
    :best_professional_editor_short_form,
    :best_professional_editor_long_form,
    ...
    :retro_best_professional_editor_short_form,
    :retro_best_professional_editor_long_form,
