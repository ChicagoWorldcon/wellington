...
Rails.application.configure do
  ...
  # NOTE This is disabled because CoNZealand does SSL on the load balancer
  # Please raise an issue if this needs to be configurable and we'll figure something out
