...
class DcContactDashboard < Administrate::BaseDashboard
  # ATTRIBUTE_TYPES
  ...
  # Overwrite this method to customize how dc contacts are displayed
  # across all pages of the admin dashboard.
  #
  # def display_resource(dc_contact)
  #   "DcContact ##{dc_contact.id}"
  # end
end
