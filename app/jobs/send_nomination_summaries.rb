...
# SendNominationSummaries exists to tell a User when they've made Nomination records so they can be sure they've been saved
  ...
  def perform
    ...
    User.transaction do
      ...
      reservations.find_each do |reservation|
        NominationMailer.nomination_ballot(reservation).deliver_now
      end
